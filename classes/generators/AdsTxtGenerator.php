...
class AdsTxtGenerator extends BaseGenerator
{
    ...
    {
        return collect(Settings::get('ads_txt_rows'))
    ...
    {
        return collect(Settings::get('ads_txt_vars'))
            ->implode(fn($var) => implode('=', $var), "\n");
    }

    protected function extendedTags(): array
    {
        return app('wmSeoGeneratorAdsTxtContentTagsPreset')->tags();
    }
}
